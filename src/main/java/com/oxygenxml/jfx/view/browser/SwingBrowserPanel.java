...
public class SwingBrowserPanel extends JPanel {
   ...
   * Constructor.
   */
  public SwingBrowserPanel(boolean developerMode) {
    this.jfxPanel = new JFXPanel();

    initComponents(developerMode);
  ...
  public void setHandler(BrowserInteractor handler) {
  ...
  private void initComponents(boolean developerMode) {
    createScene();
        ...
        changeListener = new ChangeListener<State>() {
          @Override public void changed(ObservableValue ov, State oldState, State newState) {
            if (newState == Worker.State.SUCCEEDED) {
              ...
              // The bridge should be loaded after the page is fully loaded.
              handler.pageLoaded();
            }
          }
